...
while errado == False:
    perguntas = {
        'pergunta1': {
            'pergunta': 'Você tem 18 anos ou mais?',
            'resposta': {'a': '- Sim', 'b': '- Não'},
            'resposta_certa': 'a'
        }
    }

    for vk, vn in perguntas.items():
        print(f'{vn["pergunta"]}')
        for kk, kn in vn['resposta'].items():
            print(f'{kn}')
    road = input('Digite sua resposta: ')
    if road.isalpha() == False:
        print('Digite uma resposta válida.')
        errado = False
    else:
        errado = True
        if road != 'Sim':
            print('Você não atende aos termos da idade, ou sua resposta não pôde ser reconhecida.')
        else:
            errado = True
            if road == 'Não':
                print('Você não possui idade suficiente para acessar esse programa.')
                break
            else:
                errado = True
                print('Registre-se para acessar o programa.')
                nome_do_usuario = input('Digite seu nome, por favor: ')
                if nome_do_usuario.isalpha() == False:
                    ...
                    while senha == False:
                        ...
                        if senha_do_usuario.isnumeric() == False:
                            ...
                            if len(senha1) == 1:
                                ...
                                senha = True
                                print('{}, seja bem vindo(a).'.format(nome_do_usuario))
                                acertou = False
                                while acertou == False:
                                  ...
                                  Digite "Sair" para encerrar o programa.''')
                                    ...
                                    if opcao == str('4'):
                                        salario = False
                                        while salario == False:
                                            salario_mensal = input('Digite o seu salário mensal sem decimais: R$')
                                            if salario_mensal.isnumeric() == False:
                                    ...
                                    if opcao == str('6'):
                                        ...
                                        acertou = False
                                    if opcao == str('7'):
                                        numero_x = float(input('Digite o primeiro número da divisão: '))
                                        numero_y = float(input('Digite o segundo número da divisão: '))
                                        print('''Possui mais algum número?
                                     [1] Sim
                                     [2] Não''')
                                        opcao = int(input('Sua opção: '))
                                        if opcao == 1:
                                            numero_z = float(input('Digite o terceiro número da divisão: '))
                                            print('''Possui mais algum número?
                                     [1] Sim
                                     [2] Não''')
                                            opcao = int(input('Sua opção: '))
                                            if opcao == 1:
                                                numero_a = float(input('Digite o quarto número da divisão: '))
                                                divisao = 0
                                                divisao = numero_x / numero_y / numero_z / numero_a
                                                print('O resultado da divisão será:', divisao)
                                                acertou = False
                                            else:
                                                divisao = 0
                                                divisao = numero_x / numero_y / numero_z
                                                print('O resultado da divisão será:', divisao)
                                                acertou = False
                                        else:
                                            divisao = 0
                                            divisao = numero_x / numero_y
                                            print('O resultado da divisão será:', divisao)
                                            acertou = False
                                    if opcao == str('8'):
                                   ...
                                   [6] Kelvins em Celsius''')
                                    ...
                                    if opcao == str('10'):
                                        ...
                                        if salario_mensal >= 1903.99 and salario_mensal <= 2826.65:
                                            ...
                                            print('Será cobrado anualmente pelo imposto de renda: R${:.2f}'.format(
                                                desconto_1 * 12))
                                            acertou = False
                                    ...
                                    if opcao == str('Perfil'):
                                        ...
                                        if testando != senha_do_usuario:
                                            ...
                                            print('O nome escolhido pelo usuário foi: {}'.format(nome_do_usuario))
                                            print('A senha escolhida pelo usuário foi: {}'.format(senha_do_usuario))
                                            perfil = False
                                            while perfil == False:
                                                print('''[1] Para alterar o nome.
            [2] Para alterar a senha.
            "Voltar" para retornar ao menu.''')
                                                opcao2 = input('Sua opção: ')
                                                if opcao2 == str('1'):
                                                    nn = False
                                                    while nn == False:
                                                        nome_do_usuario = input('Digite o novo nome: ')
                                                        if nome_do_usuario.isalpha() == False:
                                                            print('Apenas letras no nome.')
                                                        else:
                                                            nn = True
                                                            print('Nome alterado para {} com sucesso.'.format(
                                                                nome_do_usuario))
                                                            perfil = True
                                                            acertou = False
                                                if opcao2 == str('2'):
                                                ...
                                                if opcao2 == str('Voltar'):
                                                    ...
                                                    acertou = False
                                    if opcao == str('Sair'):
                                        print('Obrigado pela preferência {}, volte sempre.'.format(nome_do_usuario))
                                        acertou = True
